        ...
        'section_templates' => array(
            ...
            'options' 	=> array(
                ...
                array(
                    ...
                    'details'	=> __('Please choose which version font awesome you want to load. default is version 5+, set "None" if already loaded from 3rd party source(plugin or themes).','accordions'),
                    'type'		=> 'select',
                    'args' => array(
                        'version-5' => 'Verison 5+',
                        'version-4' => 'Version 4+',
