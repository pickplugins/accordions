...
class PGBlockAccordionNestedItem
{
	...
	{
		//wp_register_style('editor_style', accordions_plugin_url . 'includes/blocks/layer/index.css');
		//wp_register_script('editor_script', accordions_plugin_url . 'includes/blocks/layer/index.js', array('wp-blocks', 'wp-element'));
