...
if (!function_exists('accordions_settings_content_buy_pro')) {
    ...
    ?>
        <div class="section">
            ...
            <a class="button" href="https://pickplugins.com/accordions/?utm_source=dropdownComponent&utm_term=proFeature&utm_campaign=pluginPostGrid"><?php echo __('Buy premium', 'accordions'); ?></a>
            ...
            <table class="pro-features">
                ...
                <tr>
                    ...
                    <td> </td>
                    <td><a class="button" href="https://pickplugins.com/accordions/?utm_source=dropdownComponent&utm_term=proFeature&utm_campaign=pluginPostGrid"><?php echo __('Buy premium', 'accordions'); ?></a></td>
                </tr>
