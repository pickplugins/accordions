...
if ( ! defined('ABSPATH')) exit;  // if direct access 
	...
	?>
    <li class="tabs-nav" >
        <a style="<?php echo $header_style; ?>" class="accordions-tab-head" href="#tabs-<?php echo $index; ?>">
        <?php
        ...
        ?>
        <span class="accordions-tabs-head-title"><?php echo do_shortcode($accordions_tabs_title); ?></span>
        <?php
