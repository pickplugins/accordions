...
const PgCSSMinHeight = ({ val, onChange, breakPoint, sudoSrc }) => {
	var unitArgs = {
						...
						<InputControl
							...
							onChange={(newVal) => {
								if (newVal.includes("calc")) {
									// onChange(newVal, "minHeight", );
									if (isImportant) {
										onChange(newVal + " !important", "minHeight");
									} else {
										onChange(newVal, "minHeight");
									}
									return;
								...
								if (widthUnit == "auto") {
									...
									if (isImportant) {
										onChange(widthUnit + " !important", "minHeight");
									} else {
										onChange(widthUnit, "minHeight");
									}
								} else {
									//onChange(newVal + widthUnit, 'width');
									if (isImportant) {
										onChange(newVal + widthUnit + " !important", "minHeight");
									} else {
										...
										return (
											<div
												...
												onClick={(ev) => {
													...
													if (x.value == "auto") {
														if (isImportant) {
															onChange(x.value + " !important", "minHeight");
														} else {
															onChange(x.value, "minHeight");
														}
													} else {
														if (isImportant) {
															onChange(
					...
					<ToggleControl
						...
						onChange={(arg) => {
							...
							if (val.includes("calc")) {
								...
								if (isImportant) {
									var valX = val.replaceAll(" !important", "");
									onChange(valX, "minHeight");
									// onChange(val + " !important", "minHeight", );
								} else {
									// var valX = val.replaceAll(" !important", "");
									// onChange(valX, "minHeight", );
									onChange(val + " !important", "minHeight");
							...
							if (isImportant) {
								if (widthUnit == "auto") {
									...
									onChange(widthVal + widthUnit, "minHeight");
								}
							} else {
								if (widthUnit == "auto") {
									onChange(widthUnit + " !important", "minHeight");
								} else {
									onChange(widthVal + widthUnit + " !important", "minHeight");
								}
							}
						}}
					/>
					...
					<SelectControl
						...
						onChange={(newVal) => {
							...
							if (
								...
								if (isImportant) {
									onChange(widthVal + newVal + " !important", "minHeight");
								} else {
									onChange(widthVal + newVal, "minHeight");
								}
							}
						}}
					/>
