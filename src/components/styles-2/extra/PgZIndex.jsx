...
const PgCSSZIndex = ({ val, onChange, breakPoint, sudoSrc }) => {
	var args = {
	...
	return (
		<div className="w-full flex flex-col items-start gap-1">
			<label htmlFor="z-index" className="flex-1">
				Z Index
			</label>
			<div className="flex items-start justify-between gap-1 w-full">
				...
				<ToggleControl
					...
					onChange={(arg) => {
						...
						if (isImportant) {
							onChange(valueX, "zIndex");
						} else {
							onChange(valueX, " !important", "zIndex");
						}
					}}
				/>
			</div>
