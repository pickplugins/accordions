		...
		<div>
			...
			{proText && (
				<a
					...
					{__("Subscribe to add multiple shadows.", "accordions")}
				</a>
			)}
			<>
				{shadowObj.map((shadow, index) => {
					...
					return (
						<PanelBody
							...
							initialOpen={false}>
							<PanelRow>
								<label htmlFor="">{__("H-Offset", "accordions")}</label>
							</PanelRow>
							<PanelRow>
								<InputControl
									value={hVal}
							...
							<PanelRow>
								<label htmlFor="">{__("V-Offset", "accordions")}</label>
							</PanelRow>
							<PanelRow>
								<InputControl
									value={vVal}
							...
							<PanelRow>
								<label htmlFor="">{__("Blur", "accordions")}</label>
							</PanelRow>
							<PanelRow>
								<InputControl
									value={blurVal}
							...
							<PanelRow>
								<label htmlFor="">{__("Spread", "accordions")}</label>
							</PanelRow>
							<PanelRow>
								<InputControl
									value={spreadVal}
