										...
										<div
											...
											onClick={(ev) => {
												...
												if (isImportant) {
													...
													props.onChange(x.value, "maskPosition");
												}
											}}>
				...
				onChange={(arg) => {
					...
					if (isImportant) {
						if (isCustom) {
							...
							props.onChange(position, "maskPosition");
						}
					} else {
						if (isCustom) {
							props.onChange(
							...
							props.onChange(position + " !important", "maskPosition");
						}
					}
				}}
			/>
...
class PGcssMaskPosition extends Component {
	constructor(props) {
		super(props);
...
export default PGcssMaskPosition;
