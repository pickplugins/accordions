...
if(empty($enable_search)){$enable_search= 'no';}
...
if(empty($accordions_icons_padding)){$accordions_icons_padding = '0px';}

$accordions_icons_bg_color = get_post_meta( $post_id, 'accordions_icons_bg_color', true );
if(empty($accordions_icons_bg_color)){$accordions_icons_bg_color = '';}
...
if(empty($accordions_content_title_toggled)){$accordions_content_title_toggled = array('0'=>'');}
